...
export const products = [
{
    ...
    price: 35,
    image: [blackTeeDesign1, teeDesign1],
    category: "Men",
    subCategory: "Shirts",
    sizes: ["S", "M", "L", "XL"],
...
{
    _id : "aaaab",
    name: "Male Black tee-shirt Crack design",
    description: "A lightweight black tee shirt for men with a crack design",
    price: 35,
    image: [blackTeeDesign2, teeDesign2],
    category: "Men",
    subCategory: "Shirts",
    sizes: ["S", "M", "L", "XL"],
    date: 1716634345449, //change
