  ...
  return (
    <div className ='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className ='min-w-60'>
        <p onClick={()=>setShowFilter(!showFilter)} className ='onest-norm my-2 text-xl flex items-center cursor-pointer gap-2'>FILTERS
      ...
      <div className ='flex-1'>
          <div className ='flex justify-between text-base sm:text-2xl mb-4'>
            ...
            className ='onest-norm border-2 border-gray-300 text-sm px-2 rounded w-full md:w-auto min-w-0 max-x-xs md:max-w-sm'>
