  ...
  return (
    <div className ='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-sx sm:text-sm md:text-base text-gray-700'>
        <div>
            ...
            <p className ='onest-thick text-white'>Exchange Policy</p>
        ...
        <div>
            ...
            <p className ='onest-thick text-white'>Quality Products</p>
        ...
        <div>
            ...
            <p className ='onest-thick text-white'>Great Customer Support</p>
